...
checkpoint_name = "result_256p_cp"
    ...
    for epoch in range(1,201):
        ...
        for i in np.random.permutation(training_count):
            ...
            if images[i] is None:
                ...
                images[i]=np.expand_dims(np.float32(scipy.misc.imread(os.path.join(dir_image, file_name.replace('_ns','_as')))),axis=0)#training image
