...
def recursive_generator(label,sp):
    ...
    if sp==1024:
        net=slim.conv2d(net,6,[1,1],rate=1,activation_fn=None,scope='g_'+str(sp)+'_conv100')
...
pretrained_checkpoint_name = "result_512p_abof_var"
checkpoint_name = "result_1024p_abof_var"
